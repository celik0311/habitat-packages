...
pkg_description="Go vendor tool that works with the standard vendor file."
pkg_license=('MIT')
pkg_source="https://github.com/kardianos/govendor/archive/v${pkg_version}.tar.gz"
pkg_upstream_url=https://github.com/kardianos/govendor
